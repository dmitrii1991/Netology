...
SECRET_KEY = '+067*kqh$7$+o_7mektr@cgik$*k0w*okgl*b#mj&_s87+dc$1'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # контекстный процессор - вывод категорий
...
LOGOUT_REDIRECT_URL = "http://127.0.0.1:8000/prosto/" # интернет адрес по которому будет перенаправлен П в случае выхода с сайта
