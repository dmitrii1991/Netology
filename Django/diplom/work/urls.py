...
from .views import smartphones, phone, accessories, index, RegisterView
from django.contrib.auth.views import LoginView, LogoutView  # авторизация вход, выход
...
urlpatterns = [
    ...
    path('login/', LoginView.as_view(redirect_field_name='redirect_to'), name='auth_login'),  # авторизация вход redirect_to - переход по заданному пути
